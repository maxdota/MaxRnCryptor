...
jstring
Java_com_maxdota_maxrncryptor_RNCryptorNative_getABI(JNIEnv *env, jobject thiz) {
#if defined(__arm__)
...
jbyteArray Java_com_maxdota_maxrncryptor_RNCryptorNative_encrypt(JNIEnv *env, jobject instance, jstring raw_, jstring password_) {
...
jstring Java_com_maxdota_maxrncryptor_RNCryptorNative_decrypt(JNIEnv *env, jobject instance, jstring encrypted_, jstring password_) {
    string decrypted = "0";
    if (encrypted_ != NULL) {
        try {
